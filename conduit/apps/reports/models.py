...
class Report(TimestampModel):
    ...
    ackDetail = models.CharField(max_length=64, null=True,blank=True)
    mediaGuid = models.CharField(max_length=64, null=True,blank=True)
    ...
    mediaTypeCamera1 = models.SmallIntegerField(default=-1)
    mediaTypeCamera2 = models.SmallIntegerField(default=-1)
    mediaTypeCamera3 = models.SmallIntegerField(default=-1)
